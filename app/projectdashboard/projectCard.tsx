...
export default function ProjectCard({ project }: { project: ProjectDashboardType }) {
  ...
  return (
    <div className="m-4 w-72 min-w-72 flex-none rounded-lg border-2 p-3 shadow">
      ...
      <h4 className="text-lg font-light">
        Architect: {`${project.architect.first_name} ${project.architect.last_name}`}
      </h4>
      ...
      <div className="mt-4 flex justify-center">
        <Dialog>
          ...
          <Button
            className="row-span-1 w-full rounded-2xl border bg-green-500 text-blue-50"
